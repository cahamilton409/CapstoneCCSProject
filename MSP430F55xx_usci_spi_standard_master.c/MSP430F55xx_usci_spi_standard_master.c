...
SPI_Mode SPI_Master_Write(uint8_t reg_addr, uint8_t *reg_data, uint8_t count);
...
/*	SPI_Master_ReadReg(CMD_TYPE_2_SLAVE, TYPE_2_LENGTH);
	...
	//SPI_Master_WriteReg(CMD_TYPE_2_MASTER, MasterType0, TYPE_2_LENGTH);
	//SPI_Master_WriteReg(CMD_TYPE_1_MASTER, MasterType1, TYPE_1_LENGTH);
	//SPI_Master_WriteReg(CMD_TYPE_0_MASTER, MasterType2, TYPE_0_LENGTH);
	SPI_Master_Write(CMD_TYPE_0_MASTER, MasterType0, TYPE_0_LENGTH);
